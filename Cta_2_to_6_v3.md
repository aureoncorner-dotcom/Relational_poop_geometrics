CTA 2-6 V.3 UPDATES - CCO
2–4. Interaction & Coherence
Interaction(O, S) ⊆ R
...
Base: O → R → S → T → R → O  
Extended: O → R → S → T → R → S → O  
Use the minimal loop unless additional structure passes are required.
...
A system holds when:
O expresses intent without losing replaceability
